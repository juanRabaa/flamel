...
class RB_Customizer_API{
	...
	public function activate_selective_refresh(){
		...
		foreach ( $this->sections as $section ) {
			$dependent_settings = $section->dependent_settings();
...
class RB_Customizer_Section{
	...
	public function dependent_settings(){
		$settings_final = array();
		foreach( $this->controls as $control ){
			$settings_final = array_merge( $settings_final, $control->dependent_settings(true) );
		}
...
class RB_Customizer_Control{
	...
	public function dependent_settings( $id_only = false ){
