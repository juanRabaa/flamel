	...
	<?php if ($show_section): ?>
		<div class="section-content container">
			...
			<div class="process-desktop">
				<h6 class="process-section-title section-title"><?php echo $section_title; ?></h6>    
		...
		<?php 
		$section_separator_info = json_decode(get_theme_mod('section-process-separator-info'), true);
